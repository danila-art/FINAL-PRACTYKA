...
<head>
    <meta charset="UTF-8">
    <title>Фантастика - Книжный магазин</title>
...
<div class="main">
    ...
    $sql_vivod = $sql->query("SELECT * FROM `book` where `genre`='$fantastic'");
...
<div class="futer">
    <div class="futer_flex">
        <div id="futer_box_1">
            <a href="" id="a_1"><span id="span_1">Web-design_RP31.ru</span></a>
            <hr>

            <p>Все для Web-мастера, в системе php</p>
        </div>
        <div id="futer_box_2">
            <a href="" id="a_2">Помощь</a>
            <hr>
            <br>
